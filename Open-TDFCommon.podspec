Pod::Spec.new do |spec|
  ...
  spec.license      = { :type => "Apache", :file => "Open-TDFCommon-0.0.6-test/LICENSE" }

  spec.author             = { "jonasluo" => "jonasluo@tencent.com" }
  spec.platform     = :ios, "9.0"
  spec.source       = { :http => "https://github.com/elixxli/Open-TDFCommon/archive/refs/tags/0.0.6-test.zip" }
  spec.vendored_frameworks = 'Open-TDFCommon-0.0.6-test/TDFCommon.xcframework'
